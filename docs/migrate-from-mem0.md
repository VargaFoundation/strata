# Migrating from Mem0 to Strata

Strata's memory layer is **API-compatible in spirit** with Mem0 (add / search / get / history /
...
hybrid + graph retrieval, decay) runs locally. This guide maps the common Mem0 calls to Strata.
...
| Mem0 | Strata REST | Strata Python SDK |
|------|-------------|-------------------|
...
same add/search/history/delete semantics. Strata adds, for free:
