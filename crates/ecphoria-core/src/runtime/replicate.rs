...
//!
//! `ecphoria-core` cannot depend on the cluster layer, so it defines this trait and the cluster
...
//! [`crate::EcphoriaEngine::set_run_replicator`]; absent it, the engine writes locally.
