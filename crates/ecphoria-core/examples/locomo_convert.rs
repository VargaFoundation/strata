...
//!
//!   cargo run -p ecphoria-core --example locomo_convert -- <input.json> [locomo|longmemeval] > out.json
//!   LOCOMO_PATH=out.json cargo run -p ecphoria-core --example locomo_eval
//!
