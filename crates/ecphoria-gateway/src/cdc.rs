...
//! on [`EcphoriaEngine::memory_subscribe`](ecphoria_core::EcphoriaEngine::memory_subscribe) is POSTed as
...
async fn deliver(client: &reqwest::Client, url: &str, change: &ecphoria_core::MemoryChange) {
