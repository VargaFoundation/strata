...
A 30-second, API-key-free demonstration of Ecphoria's cognition layer — the thing that makes it
*memory*, not just storage: dedup, **contradiction resolution**, scoped recall, and bi-temporal
history.

## Run it

1. Start Ecphoria (any of):
   ```bash
...
This demo calls Ecphoria's REST API directly. To have **Claude** drive it, define two Anthropic
...
the gap Ecphoria fills versus cloud-first Mem0 and Zep's paywalled graph.
